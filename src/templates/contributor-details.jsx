      ...
      <Box padding={0} display={"flex"} flexDirection={"column"}>
        ...
        >
          <Box sx={{ paddingTop: isMobile ? 5 : 8 }}>
            <img
              src={"../../../" + props.data.asciidoc.pageAttributes.image}
        ...
        <Box
          padding={
            isDesktop ? "32px 160px" : isTablet ? "24px 64px" : "16px 32px"
          }
        >
          ...
          <Box sx={{ paddingBottom: 1.5 }}>
            ...
            <Typography variant={"h6"} textAlign={"center"}>
              {"First Commit: " +
                props.data.asciidoc.pageAttributes.firstcommit ?? "Unknown"}
            </Typography>
          </Box>
          <Box sx={{ paddingBottom: 1.5 }}>
            <Typography variant={"h6"} textAlign={"center"}>
          ...
          >
            ...
            {props.data.asciidoc.pageAttributes.email !== "" && (
              <Link to={`mailto:${props.data.asciidoc.pageAttributes.email}`}>
                <AlternateEmailIcon />
              </Link>
            )}
          </Box>
          ...
          <Box dangerouslySetInnerHTML={{ __html: props.data.asciidoc.html }} />
        </Box>
      </Box>
    </>
  );
