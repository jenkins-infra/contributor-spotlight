...
I also did some work on plugable storage changes, mainly the link:https://plugins.jenkins.io/artifact-manager-s3/[Artifact Manager on S3] plugin, to help externalize the storage of artifacts and statuses.
