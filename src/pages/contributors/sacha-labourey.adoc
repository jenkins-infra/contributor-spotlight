...
During this time, I started my consulting company during my studies to pay for my studies.
...
He's the one who said our past strategy is good, but we really need a stepping stone to go from where developers are today to this new model.
...
This illustrates how far the market was from any notion that there was a need for the simplification and streamlining of this process.
...
We had Jenkins as a service and we were already selling an enterprise Jenkins version which was mostly consisted of a few plugins.
However, our attitude was "We're a pass company, and by the way, we also do some Jenkins stuff."
Because as a company, we were wired to prove the world day in and day out, that pass was the way to go.
It took us a while to realize that at the time, the lack of standardization and cloud adoption was making it hard to go as fast as we wanted to and grow as a company.
...
I've tried implementing a few plugins and I've created a few spreadsheets that are still being used to unify some information in real time, but my involvement has been mostly non-technical.
This started with the big drama we had in 2010/2011, where we had to give birth to Jenkins from Hudson and all of the associated drama that came from it.
...
Now, we're talking about cloud, about containers, about SAS, we're talking about so many different things, and yet Jenkins was able to surf the wave at every point in time.
