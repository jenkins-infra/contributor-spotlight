...
:page-featured: true
:page-intro: Alexander Brandes is an open-source contributor and maintainer and has serves on the Jenkins governance board. He has made contributions to multiple aspects of the Jenkins project including Jenkins core, multiple plugins, weekly and long term support releases, and the community.
...
The connection with the community is a keypoint when it comes to running a successful open source project.
